...
Business semantics follow demo/kb/02-supply-chain.md and
demo/kb/03-erp-orders.md (materials, supplier rating, inventory reorder
...
demo/ontology/tables/ alongside the existing Factory/Quality dimension
CSVs -- loaded into the Fabric SQL Database by
demo/sql-database/deploy_sql_database.py.
"""
