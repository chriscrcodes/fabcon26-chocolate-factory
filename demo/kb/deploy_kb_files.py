#!/usr/bin/env python3
"""Upload demo/kb/*.md into the dimension Lakehouse's Files area, so a
Foundry IQ knowledge base's OneLake files indexer (see
demo/kb/deploy_search_indexer.py) has something to index. Unlike
demo/ontology/deploy_dimension_lakehouse.py, there's no "Load Table"
