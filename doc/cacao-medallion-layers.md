...
Table-and-policy design, now built as real KQL in `fabric/eventhouse/`.
...
Exactly the shape `simulator/src/simulator.py` emits —
...
KQL lives in `fabric/eventhouse/`:
...
**Not yet run against a live Eventhouse.** `fabric/eventhouse/README.md`
