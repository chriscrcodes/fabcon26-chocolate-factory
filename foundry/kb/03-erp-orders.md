...
Customers fall into segments reflecting order volume and channel:
`Retail`, `Wholesale`, `FoodService`, and `DirectToConsumer`.
`CreditLimit` bounds how much outstanding balance a
